...
const Footer = () => {
    return (
        <footer className="bg-[#f2f2f2]">
            ...
            <h3 className="text-[#70757a] text-[12px] md:text-[14px] leading-none p-[10px] md:p-[15px]" style={{textAlign: "center"}}>
                Developed by - Satyam Maurya, Deepak Mishra, Omkar Chauhan, Hritik Mishra</h3>
        </footer>
    );
};
